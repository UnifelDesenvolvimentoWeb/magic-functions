...
function classifyMovies(movies) {
  ...
  avaliacao["0-4.9"].sort((a, b) => a.titulo.toLowerCase() > b.titulo.toLowerCase() ? 1 : -1);
  avaliacao["5.0-7.9"].sort((a, b) => a.titulo.toLowerCase() > b.titulo.toLowerCase() ? 1 : -1);
  avaliacao["8.0-10.0"].sort((a, b) => a.titulo.toLowerCase() > b.titulo.toLowerCase() ? 1 : -1);
